            ...
            {/* <div className="row pt-5">
                <div className="col-lg-6">
                    <figure className="figure">
                        <img className="img-fluid" src="{{ asset('public/frontend') }}/img/project/img1.jpeg" alt="" />
                    </figure>
                </div>
                <div className="col-lg-6">
                    <figure className="figure">
                        <img className="img-fluid" src="{{ asset('public/frontend') }}/img/project/img2.jpeg" alt="" />
                    </figure>
                </div>
                <div className="col-lg-6">
                    <figure className="figure">
                        <img className="img-fluid" src="{{ asset('public/frontend') }}/img/project/img3.jpeg" alt="" />
                    </figure>
                </div>
                <div className="col-lg-6">
                    <figure className="figure">
                        <img className="img-fluid" src="{{ asset('public/frontend') }}/img/project/img4.jpeg" alt="" />
                    </figure>
                </div>
            </div> */}
        </>
